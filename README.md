...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2FKardFinancial%2Fkard-java-sdk)
[![Maven Central](https://img.shields.io/maven-central/v/com.getkard/kard-financial-sdk)](https://central.sonatype.com/artifact/com.getkard/kard-financial-sdk)

The Kard Java library provides convenient access to the Kard APIs from Java.
...
```groovy
dependencies {
  implementation 'com.getkard:kard-financial-sdk:11.1.0'
}
```
...
A full reference for this library is available [here](https://github.com/KardFinancial/kard-java-sdk/blob/HEAD/./reference.md).
...
public class Example {
    public static void main(String[] args) {
        KardApiClient client = KardApiClient.withCredentials("<clientId>", "<clientSecret>")
            .build()
        ;
