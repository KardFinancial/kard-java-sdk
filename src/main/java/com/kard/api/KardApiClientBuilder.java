...
import com.kard.api.core.LogConfig;
import com.kard.api.core.OAuthTokenSupplier;
...
public class KardApiClientBuilder {
    ...
    public KardApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public KardApiClientBuilder url(String url) {
     ...
     */
    public KardApiClientBuilder timeout(int timeout) {
     ...
     */
    public KardApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public KardApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public KardApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public KardApiClientBuilder addHeader(String name, String value) {
    ...
    public KardApiClient build() {
        validateConfiguration();
        return new KardApiClient(buildClientOptions());
    }

    public static final class _TokenAuth extends KardApiClientBuilder {
    ...
    public static final class _CredentialsAuth extends KardApiClientBuilder {
        ...
        public KardApiClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new KardApiClient(finalOptions);
        }
    }
