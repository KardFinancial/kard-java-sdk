...
public class AsyncKardApiClientBuilder {
    ...
    public AsyncKardApiClientBuilder url(String url) {
     ...
     */
    public AsyncKardApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncKardApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncKardApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncKardApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncKardApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncKardApiClient build() {
        validateConfiguration();
        return new AsyncKardApiClient(buildClientOptions());
    }

    public static final class _TokenAuth extends AsyncKardApiClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncKardApiClientBuilder {
        ...
        public AsyncKardApiClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncKardApiClient(finalOptions);
        }
    }
