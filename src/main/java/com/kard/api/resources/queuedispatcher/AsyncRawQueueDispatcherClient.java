...
public class AsyncRawQueueDispatcherClient {
    protected final ClientOptions clientOptions;

    public AsyncRawQueueDispatcherClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<KardApiHttpResponse<GenericNotificationResponseObject>> dispatchEvent(
    ...
    public CompletableFuture<KardApiHttpResponse<GenericNotificationResponseObject>> dispatchEvent(
        ...
        CompletableFuture<KardApiHttpResponse<GenericNotificationResponseObject>> future = new CompletableFuture<>();
