...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<KardApiHttpResponse<TokenResponse>> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public CompletableFuture<KardApiHttpResponse<TokenResponse>> getToken(
        ...
        CompletableFuture<KardApiHttpResponse<TokenResponse>> future = new CompletableFuture<>();
