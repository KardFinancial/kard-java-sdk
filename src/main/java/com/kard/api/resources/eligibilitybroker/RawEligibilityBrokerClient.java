...
public class RawEligibilityBrokerClient {
    protected final ClientOptions clientOptions;

    public RawEligibilityBrokerClient(ClientOptions clientOptions) {
     ...
     */
    public KardApiHttpResponse<Void> ingest(IngestRequestBody request) {
     ...
     * Send events to be ingested by the eligibility broker to change a user's eligibility.
     */
    public KardApiHttpResponse<Void> ingest(IngestRequestBody request, RequestOptions requestOptions) {
