...
@JsonDeserialize(builder = FailedTransactionRelationships.Builder.class)
public final class FailedTransactionRelationships {
    ...
    private FailedTransactionRelationships(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FailedTransactionRelationships && equalTo((FailedTransactionRelationships) other);
    }
    ...
    private boolean equalTo(FailedTransactionRelationships other) {
    ...
    public interface UserStage {
        ...
        Builder from(FailedTransactionRelationships other);
    }
    ...
    public interface _FinalStage {
        FailedTransactionRelationships build();
    }
    ...
    public static final class Builder implements UserStage, OfferStage, TransactionStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(FailedTransactionRelationships other) {
            user(other.getUser());
        ...
        @java.lang.Override
        public FailedTransactionRelationships build() {
            return new FailedTransactionRelationships(user, offer, transaction, additionalProperties);
        }
    }
}
