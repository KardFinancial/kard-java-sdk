...
public final class Subscription {
    ...
    private Subscription(String id, SubscriptionAttributes attributes, Map<String, Object> additionalProperties) {
        this.id = id;
    ...
    public interface AttributesStage {
        _FinalStage attributes(@NotNull SubscriptionAttributes attributes);
    }
    ...
    public static final class Builder implements IdStage, AttributesStage, _FinalStage {
        ...
        public _FinalStage attributes(@NotNull SubscriptionAttributes attributes) {
        ...
        public Subscription build() {
            return new Subscription(id, attributes, additionalProperties);
        }
    }
}
