...
public class AsyncRawTransactionsClient {
    ...
    public CompletableFuture<KardApiHttpResponse<TransactionsResponse>> create(
        ...
        CompletableFuture<KardApiHttpResponse<TransactionsResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new KardApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TransactionsResponse.class),
                                response));
                        return;
                    }
                    try {
                        switch (response.code()) {
                            case 207:
                                future.completeExceptionally(new CreateIncomingTransactionsMultiStatus(
    ...
    public CompletableFuture<KardApiHttpResponse<FraudulentTransactionObject>> createFraudMarkers(
        ...
        CompletableFuture<KardApiHttpResponse<FraudulentTransactionObject>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new KardApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, FraudulentTransactionObject.class),
                                response));
                        return;
                    }
                    try {
                        switch (response.code()) {
                            case 207:
                                future.completeExceptionally(new FraudMultiStatus(
                                        ObjectMappers.JSON_MAPPER.readValue(
    ...
    public CompletableFuture<KardApiHttpResponse<CreateAuditResponseBody>> createAudits(
        ...
        CompletableFuture<KardApiHttpResponse<CreateAuditResponseBody>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    try {
                        switch (response.code()) {
                            case 207:
                                future.completeExceptionally(new CreateAuditMultiStatus(
                                        ObjectMappers.JSON_MAPPER.readValue(
    ...
    public CompletableFuture<KardApiHttpResponse<GetEarnedRewardsResponse>> getEarnedRewards(
        ...
        CompletableFuture<KardApiHttpResponse<GetEarnedRewardsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
