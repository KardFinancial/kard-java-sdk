...
public final class CreateMainPageAttributes {
    ...
    private CreateMainPageAttributes(String name, int availableSlots, Map<String, Object> additionalProperties) {
        this.name = name;
    ...
    public static final class Builder implements NameStage, AvailableSlotsStage, _FinalStage {
        ...
        public CreateMainPageAttributes build() {
            return new CreateMainPageAttributes(name, availableSlots, additionalProperties);
        }
