...
@JsonDeserialize(builder = EmailPlacementData.Builder.class)
public final class EmailPlacementData {
    private final String id;

    private final EmailPlacementAttributes attributes;

    private final Optional<PlacementRelationships> relationships;

    private final Map<String, Object> additionalProperties;

    private EmailPlacementData(
            String id,
            EmailPlacementAttributes attributes,
    ...
    public EmailPlacementAttributes getAttributes() {
        return attributes;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EmailPlacementData && equalTo((EmailPlacementData) other);
    }
    ...
    private boolean equalTo(EmailPlacementData other) {
    ...
    public interface IdStage {
        ...
        Builder from(EmailPlacementData other);
    }

    public interface AttributesStage {
        _FinalStage attributes(@NotNull EmailPlacementAttributes attributes);
    }

    public interface _FinalStage {
        EmailPlacementData build();
    ...
    public static final class Builder implements IdStage, AttributesStage, _FinalStage {
        ...
        private EmailPlacementAttributes attributes;
        ...
        @java.lang.Override
        public Builder from(EmailPlacementData other) {
            id(other.getId());
        ...
        public _FinalStage attributes(@NotNull EmailPlacementAttributes attributes) {
        ...
        @java.lang.Override
        public EmailPlacementData build() {
            return new EmailPlacementData(id, attributes, relationships, additionalProperties);
        }
