...
public final class CreateStandardAttributes {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.name, this.status, this.availableSlots, this.contentStrategyId);
    }
    ...
    public static final class Builder implements NameStage, AvailableSlotsStage, _FinalStage {
        ...
        public CreateStandardAttributes build() {
            return new CreateStandardAttributes(name, status, availableSlots, contentStrategyId, additionalProperties);
        }
