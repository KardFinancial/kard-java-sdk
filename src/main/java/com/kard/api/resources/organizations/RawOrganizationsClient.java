...
public class RawOrganizationsClient {
     ...
     */
    public KardApiHttpResponse<ExternalOrganizationResponse> get(String organizationId) {
     ...
     * Retrieve organization details for the authenticated issuer
     */
    public KardApiHttpResponse<ExternalOrganizationResponse> get(String organizationId, RequestOptions requestOptions) {
