...
public class AsyncRawTxnMapServiceClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTxnMapServiceClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<KardApiHttpResponse<Void>> deleteTxnMap(DeleteTxnMapRequest request) {
     ...
     * Call this endpoint to delete one or many transaction maps entry.
     */
    public CompletableFuture<KardApiHttpResponse<Void>> deleteTxnMap(
            DeleteTxnMapRequest request, RequestOptions requestOptions) {
