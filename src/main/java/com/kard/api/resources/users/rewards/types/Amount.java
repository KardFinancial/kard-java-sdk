...
public final class Amount {
    ...
    private Amount(AmountType type, int value, Map<String, Object> additionalProperties) {
        this.type = type;
        this.value = value;
    ...
    public interface TypeStage {
        ValueStage type(@NotNull AmountType type);
    ...
    public static final class Builder implements TypeStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("type")
        public ValueStage type(@NotNull AmountType type) {
        ...
        @java.lang.Override
        public Amount build() {
            return new Amount(type, value, additionalProperties);
        }
