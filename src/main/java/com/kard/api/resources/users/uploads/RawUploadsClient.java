...
public class RawUploadsClient {
    protected final ClientOptions clientOptions;

    public RawUploadsClient(ClientOptions clientOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new KardApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateUploadResponseObject.class),
                        response);
            }
            try {
    ...
    public KardApiHttpResponse<CreateUploadPartResponseObject> createPart(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new KardApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateUploadPartResponseObject.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public KardApiHttpResponse<UpdateUploadResponseObject> update(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new KardApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateUploadResponseObject.class),
                        response);
            }
            try {
                switch (response.code()) {
