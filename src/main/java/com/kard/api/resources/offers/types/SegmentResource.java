...
@JsonDeserialize(builder = SegmentResource.Builder.class)
public final class SegmentResource {
    ...
    private SegmentResource(String id, Map<String, Object> attributes, Map<String, Object> additionalProperties) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SegmentResource && equalTo((SegmentResource) other);
    }
    ...
    private boolean equalTo(SegmentResource other) {
    ...
    public interface IdStage {
        ...
        Builder from(SegmentResource other);
    }

    public interface _FinalStage {
        SegmentResource build();

        /**
         * <p>Segment attributes</p>
         */
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(SegmentResource other) {
            id(other.getId());
        ...
        public SegmentResource build() {
            return new SegmentResource(id, attributes, additionalProperties);
        }
    }
}
