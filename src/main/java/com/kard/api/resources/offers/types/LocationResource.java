...
@JsonDeserialize(builder = LocationResource.Builder.class)
public final class LocationResource {
    ...
    private LocationResource(String id, Map<String, Object> attributes, Map<String, Object> additionalProperties) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LocationResource && equalTo((LocationResource) other);
    }
    ...
    private boolean equalTo(LocationResource other) {
    ...
    public interface IdStage {
        ...
        Builder from(LocationResource other);
    }

    public interface _FinalStage {
        LocationResource build();
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(LocationResource other) {
            id(other.getId());
        ...
        public LocationResource build() {
            return new LocationResource(id, attributes, additionalProperties);
        }
    }
}
