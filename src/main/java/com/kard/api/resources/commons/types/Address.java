...
public final class Address {
    ...
    private Address(String street, String city, State state, String zipCode, Map<String, Object> additionalProperties) {
        this.street = street;
        this.city = city;
        this.state = state;
    ...
    public static final class Builder implements StreetStage, CityStage, StateStage, ZipCodeStage, _FinalStage {
        ...
        public Address build() {
            return new Address(street, city, state, zipCode, additionalProperties);
        }
    }
}
